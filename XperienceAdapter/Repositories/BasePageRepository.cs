...
namespace XperienceAdapter.Repositories
{
		...
		where TPage : TreeNode, new()
	{
        ...
        public Task<IEnumerable<TPageDto>> GetPagesByTypeAndCultureAsync(CancellationToken cancellationToken, IEnumerable<string> types, SiteCulture culture, string cacheKey, Action<MultiDocumentQuery>? filter = null, Func<TPage, TPageDto, TPageDto>? additionalMapper = null, bool includeAttachments = false, params string[] cacheDependencies)
        {
